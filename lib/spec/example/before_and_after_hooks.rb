  ...
  module Example
    module BeforeAndAfterHooks
      ...
      def prepend_before(*args, &block)
        scope = Spec::Example.scope_from(*args)
        before_parts_from_scope(scope).unshift(block)
      end
      ...
      def append_before(*args, &block)
        scope = Spec::Example.scope_from(*args)
        before_parts_from_scope(scope) << block
      end
      ...
      def prepend_after(*args, &block)
        scope = Spec::Example.scope_from(*args)
        after_parts_from_scope(scope).unshift(block)
      end
      ...
      def append_after(*args, &block)
        scope = Spec::Example.scope_from(*args)
        after_parts_from_scope(scope) << block
      end
