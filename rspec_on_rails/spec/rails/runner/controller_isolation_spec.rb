...
describe "a controller spec running in isolation mode", :context_type => :controller do
...
describe "a controller spec running in integration mode", :context_type => :controller do
  controller_name :controller_spec
  integrate_views
