    ...
    describe Main do
      ...
      describe "#share_examples_as" do
        ...
        it "should create a shared ExampleGroup" do
          group = @main.share_examples_as @group_name do end
          group.should be_an_instance_of(Spec::Example::SharedExampleGroup)
        end
        ...
        it "should bark if you pass it something not-constantizable" do
          lambda do
            @group = @main.share_examples_as "Non Constant" do end
          end.should raise_error(NameError, /The first argument to share_examples_as must be a legal name for a constant/)
        end
