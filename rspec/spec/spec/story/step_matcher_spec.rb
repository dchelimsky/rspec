  ...
  module Story
    describe MatchingStep do
      ...
      it "should make complain with no block" do
        lambda {
          step_matcher = MatchingStep.new("foo")
        }.should raise_error
      end
      ...
      it "should perform itself with one parameter" do
        # given
        $result = nil
        step = MatchingStep.new 'an account with $count dollars' do |count|
          $result = count
        end
        instance = Object.new
      ...
      it "should perform itself with 2 parameters" do
        ...
        $account_type = nil
        $amount = nil
        step = MatchingStep.new 'a $account_type account with $amount dollars' do |account_type, amount|
