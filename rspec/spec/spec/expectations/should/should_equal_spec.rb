...
context "should_equal" do
  ...
  specify "should fail when objects are not the same instance" do
    lambda { "apple".should_equal("apple") }.should_fail_with "expected \"apple\" to equal \"apple\" (using .equal?)"
    lambda { "apple".should.equal("apple") }.should_fail_with "expected \"apple\" to equal \"apple\" (using .equal?)"
    lambda { "apple".should equal("apple") }.should_fail_with "expected \"apple\" to equal \"apple\" (using .equal?)"
  end
end