...
module Expectations
module Helper
context "ShouldBeTrue" do
    specify "should raise when object is false" do
        lambda do
          false.should_be(true)
        end.should_raise(ExpectationNotMetError)
      
    end
    specify "should raise when object is nil" do
        lambda do
          nil.should_be(true)
        end.should_raise(ExpectationNotMetError)
    ...
    specify "shouldnt raise when object is true" do
        lambda do
          true.should_be(true)
        end.should_not_raise
