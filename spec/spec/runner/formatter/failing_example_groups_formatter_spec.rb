    ...
    module Formatter
      describe FailingExampleGroupsFormatter do
        ...
        it "should add example name for each failure" do
          ...
          formatter.example_failed("e 1", nil, Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
          formatter.add_example_group(Class.new(::Spec::Example::ExampleGroupDouble).describe("b 2"))
          formatter.example_failed("e 2", nil, Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
          formatter.example_failed("e 3", nil, Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
        ...
        it "should delimit ExampleGroup superclass descriptions with :" do
          ...
          formatter.example_failed("failure", nil, ::Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
