    ...
    module Formatter
      describe FailingExamplesFormatter do
        ...
        it "should add example name for each failure" do
          ...
          @formatter.example_failed(example_group_1.it("a1"){}, nil, ::Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
          @formatter.add_example_group(example_group_2)
          @formatter.example_failed(example_group_2.it("b2"){}, nil, ::Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
          @formatter.example_failed(example_group_2.it("b3"){}, nil, ::Spec::Runner::Reporter::Failure.new(nil, RuntimeError.new, "g"))
