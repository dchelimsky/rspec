  ...
  module Example
    describe ExampleMethods do
      ...
      describe "#backtrace" do        
        it "returns the backtrace from where the example was defined" do
          example = ExampleGroup.dup.new ExampleDescription.new(nil)
      ...
      describe "#subject" do
        ...
        it "should return an instance of the described class" do
          ...
          example = group.new(ExampleDescription.new(nil))
    ...
    describe "#options" do
      it "should expose the options hash" do
        example = ExampleGroupDouble.new ExampleDescription.new("name", :this => 'that') do; end
